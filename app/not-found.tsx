...
export default function NotFound() {
  return (
    <>
      <Header />
      <main className="min-h-screen bg-navy-dark flex items-center justify-center relative overflow-hidden">
        {/* Background glow */}
        ...
        <div className="relative z-10 text-center px-6 max-w-xl mx-auto">
          ...
          <h1 className="font-cinzel text-3xl text-ivory font-bold mb-4">Page Not Found</h1>
          <div className="w-12 h-0.5 bg-gold mx-auto mb-6" />
          <p className="font-inter text-silver leading-relaxed mb-8">
