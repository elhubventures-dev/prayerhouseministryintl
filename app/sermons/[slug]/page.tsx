...
const sermonData: Record<string, any> = {
  'the-power-of-prevailing-prayer': {
    ...
    relatedSermons: [
      ...
      { slug: 'revival-fire-are-you-ready', title: 'Revival Fire — Are You Ready?', speaker: 'Rev. Apostle E.S. Hugo', duration: '48 min', thumbnail: '/images/phmi-2.jpg' },
    ],
  },
}
