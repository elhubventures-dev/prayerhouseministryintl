...
const sermonData: Record<string, any> = {
  'the-power-of-prevailing-prayer': {
    ...
    relatedSermons: [
      { slug: 'breaking-every-chain', title: 'Breaking Every Chain', speaker: 'Rev. Apostle E.S. Hugo', duration: '50 min', thumbnail: 'https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=400&q=80' },
      { slug: 'revival-fire-are-you-ready', title: 'Revival Fire — Are You Ready?', speaker: 'Rev. Apostle E.S. Hugo', duration: '48 min', thumbnail: 'https://images.unsplash.com/photo-1470115636492-6d2b56f9146d?w=400&q=80' },
    ],
  },
}
