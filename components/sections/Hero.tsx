  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <motion.div
        ...
        style={{
          backgroundImage: `url('https://images.unsplash.com/photo-1438232992991-995b671e4b8d?w=1920&q=80')`,
        }}
      ...
      {/* Dark overlay */}
      <div className="absolute inset-0 bg-gradient-to-b from-navy-dark/60 via-navy-dark/75 to-navy-dark/95" />
      ...
      <div className="relative z-10 text-center max-w-5xl mx-auto px-6 lg:px-8 pt-24 pb-16">
        ...
        >
          ...
          <motion.h1
            variants={heroText}
            className="font-cinzel text-4xl md:text-5xl lg:text-7xl text-ivory leading-[1.15] font-bold"
          >
            Raising Lives<br />
          ...
          <motion.p
            variants={heroText}
            className="font-playfair text-silver text-lg md:text-xl italic max-w-2xl leading-relaxed"
          >
          ...
          >
            ...
            <motion.div whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.97 }}>
              <Link
                href="/#prayer-request"
                className="font-montserrat text-sm font-semibold text-silver/80 hover:text-gold transition-colors flex items-center gap-2 py-4 px-4"
              >
                🙏 Request Prayer
          ...
          <motion.p
            variants={heroText}
            className="font-garamond text-silver/50 text-sm italic mt-4"
          >
      ...
      >
        <span className="font-montserrat text-[10px] text-silver/50 tracking-widest uppercase">Scroll</span>
