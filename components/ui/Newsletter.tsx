  ...
  return (
    <form onSubmit={onSubmit} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
      <input
        ...
        className="flex-1 bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-foreground text-sm font-inter placeholder-silver/40 focus:outline-none focus:border-gold/50 transition-colors"
      />
      <motion.button
